...
function Section_01({ data }) {

  return (
    <HalfPageSectionContainer
      height={ emergeLines.chapter04.length_01 }
      emerge={ emergeLines.chapter04.slide_00_end }>

      {/* display map */ }
      <HalfPageMapGrid
        data={ data }
        center={ map_settings.map_details.chapter04.center }
        zoom={ map_settings.map_details.chapter04.zoom } />
